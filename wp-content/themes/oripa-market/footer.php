...
<footer id="site-footer" class="site-footer">
	<img class="footer-mascot" src="<?php echo esc_url( ORIPA_THEME_URI . '/assets/img/mascot-footer.webp?ver=' . ORIPA_THEME_VERSION ); ?>" alt="" width="108" height="138" decoding="async">
	<div class="wrap">
