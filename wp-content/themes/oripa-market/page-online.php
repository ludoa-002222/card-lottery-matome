<?php
/**
 * オンライン抽選まとめ。静的プロトタイプ pages/online.html を移植。
 * 一覧は app.js(initMethodPage 'online')。
 *
...
?>
<main class="wrap">
	<?php echo oripa_breadcrumb( array( array( 'label' => 'オンライン抽選' ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	<div class="page-title"><span class="updated-badge" id="updated-badge"></span><h1>オンライン抽選まとめ</h1></div>
