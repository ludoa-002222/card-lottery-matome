 ...
 *
 * ⚠️ 本番（oripa-market.com）で実行しないこと。
 *
 * ここで投入されるボックス（bin/seed-data/boxes.json の「ロマンスドーン」
 * 「クォーターセンチュリーレガシー」「プレミアムパック」等）は実在しない商品名で、
 * 開発用のダミーである。過去に本番へ投入されたまま公開状態で残っており、
 * 2026-09-09 に「実在しない抽選が一覧に載っている」「商品画像が無いボックスがある」
 * という形で表面化した。
 *
 * ダミーが本番に入ってしまった場合は、実在商品の画像を割り当てて取り繕わず、
 * 情報収集リポジトリの scraper-poc/cleanup-seed-data.js で片付ける。
 *
...
$legal_content = array(
	'about'   => "<div class=\"trust-badges\" style=\"margin:18px 0 26px;\">\n<div class=\"trust-badge\"><span class=\"ico\">🛡️</span><div><h3>二重チェック体制</h3><p>AIによる一次収集と、人による公式情報との突合確認を組み合わせています。</p></div></div>\n<div class=\"trust-badge\"><span class=\"ico\">🎯</span><div><h3>正確性を最優先</h3><p>速報性より正確性を重視し、確認が取れた情報のみ掲載します。</p></div></div>\n</div>\n<p>「オリパマーケット」は、ポケモンカード・ワンピースカード・遊戯王OCGなどトレーディングカードの抽選販売・予約情報をまとめる情報サイトです。詳しい検証プロセスは<a href=\"/trust/\">情報の正確性について</a>をご覧ください。</p>\n<h2>掲載方針</h2>\n<ul>\n<li>各店舗・公式サイトで発表された情報をもとに掲載しています</li>\n<li>受付期間・応募条件は随時変更される可能性があるため、応募前に必ず公式ページをご確認ください</li>\n<li>当サイトは抽選の実施主体ではなく、実施主体は掲載各店舗となります</li>\n<li>データ更新にはAIによる一次チェックと人による確認を組み合わせ、鮮度と正確性の両立に努めています</li>\n</ul>\n<h2>お問い合わせ</h2>\n<p>掲載情報の誤りや修正依頼は、<a href=\"/contact/\">お問い合わせフォーム</a>よりご連絡ください。</p>",
	'faq'     => "<div class=\"accordion-item\"><details><summary>掲載されている抽選情報は正確ですか？</summary>\n<p>各店舗・公式サイトの発表をもとに掲載していますが、内容は予告なく変更される場合があります。応募前に必ず公式ページをご確認ください。</p></details></div>\n<div class=\"accordion-item\"><details><summary>会員登録は必要ですか？</summary>\n<p>当サイトの閲覧に会員登録は不要です。抽選への応募時に、応募先の店舗・サービス側で会員登録が必要になる場合があります（カードの「会員登録要」バッジで事前に確認できます）。</p></details></div>\n<div class=\"accordion-item\"><details><summary>抽選に外れた場合の返金はありますか？</summary>\n<p>当サイトは抽選の実施主体ではないため、返金対応は行っておりません。各店舗の規約をご確認ください。</p></details></div>\n<div class=\"accordion-item\"><details><summary>情報の誤りを見つけました。どこに連絡すればよいですか？</summary>\n<p><a href=\"/contact/\">お問い合わせフォーム</a>よりご連絡ください。確認のうえ速やかに修正いたします。</p></details></div>\n<div class=\"accordion-item\"><details><summary>新しい抽選情報はどれくらいの頻度で追加されますか？</summary>\n<p>毎日複数回、AIによる巡回チェックと人による確認を組み合わせて更新しています。各ページの「最終更新」表示をご確認ください。</p></details></div>",
	// 会社情報は2026-09-09にLUDOAの公開情報（ludoa.jp/company-overview）から反映。設立年月は2026-09-09に確認して記入。
	'company' => "<table class=\"shop-table\"><tbody>\n<tr><th style=\"width:160px;\">会社名</th><td>株式会社LUDOA</td></tr>\n<tr><th>所在地</th><td><strong>本社</strong>：〒153-0064　東京都目黒区下目黒1丁目1番14号 コノトラビル7階<br><strong>札幌支社</strong>：〒064-0804　北海道札幌市中央区南4条西5丁目 第二観光会館ビル6F</td></tr>\n<tr><th>代表者</th><td>代表取締役　柴田 滉生</td></tr>\n<tr><th>設立</th><td>2025年9月</td></tr>\n<tr><th>資本金</th><td>1,000,000円</td></tr>\n<tr><th>従業員数</th><td>10名（業務委託を含む）</td></tr>\n<tr><th>事業内容</th><td>WEBマーケティング＆コンサルティング事業（WEB集客コンサルティング／SEO運用代行／広告運用代行／SNS運用代行・内製化支援）<br>テクノロジー＆DXソリューション事業（AI・システム開発／業務効率化・各種DX化支援）<br>クリエイティブ＆デザイン事業（WEBサイト制作／映像制作・編集・写真撮影／ロゴ・名刺等デザイン制作）<br>メディア運営事業（本サイト「オリパマーケット」の企画・運営）</td></tr>\n<tr><th>コーポレートサイト</th><td><a href=\"https://ludoa.jp/\" target=\"_blank\" rel=\"noopener\">https://ludoa.jp/</a></td></tr>\n<tr><th>お問い合わせ</th><td>本サイトの掲載内容に関するお問い合わせは <a href=\"https://ludoa.jp/contact/\" target=\"_blank\" rel=\"noopener\">株式会社LUDOA お問い合わせフォーム</a> よりご連絡ください。</td></tr>\n</tbody></table>",
